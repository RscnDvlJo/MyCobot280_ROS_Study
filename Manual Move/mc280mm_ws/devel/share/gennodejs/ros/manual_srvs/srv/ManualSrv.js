...
class ManualSrvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ManualSrvRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ManualSrvRequest
    let len;
    let data = new ManualSrvRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ManualSrvRequest(null);
...
class ManualSrvResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ManualSrvResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ManualSrvResponse
    let len;
    let data = new ManualSrvResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ManualSrvResponse(null);
...
module.exports = {
  Request: ManualSrvRequest,
  Response: ManualSrvResponse,
  md5sum() { return 'cb9460bf78e499f0b8513944c7615a57'; },
  datatype() { return 'manual_srvs/ManualSrv'; }
};
