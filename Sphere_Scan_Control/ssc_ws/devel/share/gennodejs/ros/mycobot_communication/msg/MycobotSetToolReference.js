...
// (in-package mycobot_communication.msg)
...
class MycobotSetToolReference {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MycobotSetToolReference(null);
  ...
  static datatype() {
    ...
    return 'mycobot_communication/MycobotSetToolReference';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MycobotSetToolReference(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = MycobotSetToolReference;
